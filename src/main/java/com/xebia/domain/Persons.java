...
public class Persons
{
	...
	public Persons(final Person... args)
	{
		persons = Arrays.asList(args);
	}

	public Persons(final List<Person> args)
	{
		persons = args;
	}
	 ...
	 */
	public Persons filter(final PersonFilter personFilter)
	{
	 ...
	 */
	public Persons sort(final Comparator<Person> comparator)
	{
	...
	public static class PersonSelector
	{
		 ...
		 */
		public static boolean maleAdults(final Person person)
		{
		 ...
		 */
		public static boolean femaleAdults(final Person person)
		{
			return person.isAdult() && !person.isMale();
		}
	}
