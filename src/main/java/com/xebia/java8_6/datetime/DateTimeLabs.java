...
public class DateTimeLabs
{
	 ...
	 */
	public static String calculateAge(final LocalDate birthday)
	{
		return "0 years";
	}
	 ...
	 * @param year
	 * @param month
	 * @param numberOfOccurrence the occurrence of the day in the month to calculate, i.e 2nd
	 *                           Monday in March
	 */
	public static MonthDay calculateDayOfMonth(final Year year, final Month month, final DayOfWeek day, final int numberOfOccurrence)
	{
		return MonthDay.now();
	}
	 ...
	 * </pre>
	 */
	public static List<MonthDay> createFederalHolidays(final Year year)
	{
		return Arrays.asList(MonthDay.of(JANUARY, 1), //
	...
	public static long countWorkingDays(final Year year)
	{
		return year.length();
	}
